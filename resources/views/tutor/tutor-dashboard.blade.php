...
<div class="col-md-7 col-lg-8 col-xl-9">
    ...
    <div class="row">
        <div class="col-md-12 col-lg-4 dash-board-list blue">
            <div class="dash-widget">
                ...
                <div class="dash-widget-info">
                    <h3>{{$totalStudentBookings}}</h3>
                    <h6>Total Student Bookings</h6>
                </div>
            </div>
        </div>
        <div class="col-md-12 col-lg-4 dash-board-list yellow">
            <div class="dash-widget">
                ...
                <div class="dash-widget-info">
                    <h3>{{env('CURRENCY_SIGN')}}{{$totalEarn}}</h3>
                    <h6>Total Earn</h6>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h4 class="mb-4">Student Lecture Book List</h4>
...
<script>
    ...
    function loadMore(){
        ...
        $.ajax({
            type : 'GET',
            url: "{{url('/tutor/tutor-dashboard-page')}}"+'?page='+pageNumber,
            dataType:'json',                
    ...
    function viewDetails(id){
        ...
        $.ajax({
            type : 'GET',
            url: "{{url('/tutor/tutor-dashboard-details')}}"+'?id='+id,
            dataType:'json',                
            success : function(data){                
    ...
    function clickBookingStatus(get_b_id,get_value){
        ...
        if(get_value == 'r' || get_value== 'a' && get_b_id > 0){
            $.ajax({
                type : 'POST',
                url: "{{url('/tutor/tutor-dashboard-change-status')}}",
