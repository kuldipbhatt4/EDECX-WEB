          ...
          <div class="col-sm-12 col-lg-12">
             <div class="iq-card">
                ...
                <div class="iq-card-body">
                   <form method="post" action="/edecx-admin/student/student-list" >
                    {{ csrf_field() }}
                      <div class="row">
                         ...
                         <div class="col-lg-12">
                            ...
                            <button type="button" class="btn iq-bg-danger" onclick="window.location='{{ url('edecx-admin/student/index') }}'">Cancel</button>
                         </div>
                      </div>
                   </form>
                </div>
