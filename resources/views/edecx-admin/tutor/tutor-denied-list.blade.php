                ...
                <div class="iq-card">
                   <div class="iq-card-header d-flex justify-content-between">
                      <div class="iq-header-title">
                         <h4 class="card-title">Tutor Denied List</h4>
                      </div>
                   </div>
                               ...
                               <td>{{ $tutors->firstItem() + $key }}</td>
                                  ...
                                  <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a data-href="{{ URL::asset('/edecx-admin/tutor/tutor-denied-list/'.$tutor->id) }}" data-toggle="modal" data-target="#confirm-delete">
