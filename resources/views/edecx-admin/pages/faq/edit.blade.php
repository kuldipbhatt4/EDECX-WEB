            ...
            <div class="iq-card-header d-flex justify-content-between">
             ...
             <div class="iq-card">
                <div class="iq-card-body">
                   <form method="POST" action="{{ action('Admin\Auth\FaqController@update', $id)}}">
                    {{ csrf_field() }}
                  <div class="row">
                       <div class="col-lg-12 col-md-12">
                          <div class="form-group">
                             ...
                             <select name="student_tutor" name="select[]">
                                  ...
                                  <option {{old('student_tutor',$faqs->student_tutor)=="0"? 'selected':''}}  value="0">Student</option>
                                  <option {{old('student_tutor',$faqs->student_tutor)=="1"? 'selected':''}}  value="1">Tutor</option>
                             </select>
                          </div>
                       </div>
                       <div class="col-lg-12 col-md-12">
                          <div class="form-group">
                             ...
                             <input type="text" class="form-control" id="faq_question" name="faq_question" placeholder="FAQ Question"  value ={{ $faqs->faq_question }}>
                       ...
                       <div class="col-lg-12 col-md-12">
                          ...
                          <textarea id="default" name="faq_answer" placeholder="Enter Answer">{{ $faqs->faq_answer }}</textarea>
