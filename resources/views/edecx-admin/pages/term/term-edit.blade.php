          ...
          <div class="col-sm-12 col-lg-12">
             <div class="iq-card">
                <div class="iq-card-body">
                   <form method="post" action="{{ action('Admin\Auth\TermsConditionController@update', $id)}}">
                      {{ csrf_field() }}
                    <div class="row">
                         <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                               <label for="version">Create version</label>
                               <input type="text" class="form-control" id="version" name="version" placeholder="Enter Version" value="{{ $term->version }}">
                         ...
                         <div class="col-lg-12 col-md-12">
                            ...
                            <textarea id="default" name="condition" placeholder="Enter Content">
                                {{ $term->condition }}
                            </textarea>
